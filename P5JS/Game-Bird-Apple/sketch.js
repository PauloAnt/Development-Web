...
function preload() {
    p1 = loadImage("/Game-Bird-Apple/p1.png")
    p2 = loadImage("/Game-Bird-Apple/p2.png")
    p3 = loadImage("/Game-Bird-Apple/p3.png")
    maca = loadImage("/Game-Bird-Apple/maca.png")
    plim = loadSound("/Game-Bird-Apple/plim.mp3")
}
